...
Command comments have an additional filter. Only PR issue comments or review comments whose first non-whitespace token is `/bb`, `/zeeq`, `+bb`, or `+zeeq` enter the feedback pipeline.
