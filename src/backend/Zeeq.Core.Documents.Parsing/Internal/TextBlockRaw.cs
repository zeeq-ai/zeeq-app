...
/// <param name="HeadingPath">Hierarchical path from root to this heading, joined with <c>" > "</c>. Example: <c>"Guide > Installation > Linux"</c>.</param>
/// <param name="Body">The body text of the section (paragraphs, non-code lines).</param>
internal readonly record struct TextBlockRaw(
